...
<div class="row-fluid">
	<div class="row-fluid">
		<div class="pull-left full-width m-bottom m-top">
            <div class="subtitle-container">
                <h2>{{"Productos de ejemplo" | translate}}</h2>
            </div>
			<div class="grid-row visible-when-content-ready m-top-half" data-store="category-grid>
					...
					<div class="item">
						...
						<div class="item-info-container">
							...
							<div class="item-price-container price m-none-xs">
								<span class="price-compare d-inline-block">
					...
					<div class="item">
						...
						<div class="item-info-container">
							...
							<div class="item-price-container price m-none-xs">
								...
								<span class="price item-price h6" id="price_display">{{"102000" | money }}
							</span>
							</div>	
						</div>
					</div>
				...
				<div class="span3 item-container">
					<div class="item">
						...
						<div class="item-info-container">
							<div class="title">
								<a href="/product/example" class="item-name" title="{{ product.name }}">{{ "Producto de ejemplo" | translate }}
								</a>
							</div>
							<div class="item-price-container price m-none-xs">
								<span class="price-compare d-inline-block">
