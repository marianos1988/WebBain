...
{% set has_logo_left = settings.version_theme != 'box' and settings.logo_position == 'left' %}
...
{% set big_item_desktop = settings.grid_columns_desktop == '2' or settings.grid_columns_desktop == '3' %}

.item-image-container {
  position: relative;
  overflow: hidden;
  {% if settings.grid_columns_desktop != '4' %}
    max-height: 840px;
  {% else %}
    max-height: 300px;
  {% endif %}
